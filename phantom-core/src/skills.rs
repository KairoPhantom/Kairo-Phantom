...
impl SkillManager {
    pub fn new() -> Self {
        ...
        skills.insert(CommandMode::Design, include_str!("./skills/design/SKILL.md").to_string());
        skills.insert(CommandMode::Check,  include_str!("./skills/check/SKILL.md").to_string());
        skills.insert(CommandMode::Write,  include_str!("./skills/write/SKILL.md").to_string());
        skills.insert(CommandMode::Learn,  include_str!("./skills/learn/SKILL.md").to_string());
        skills.insert(CommandMode::Read,   include_str!("./skills/read/SKILL.md").to_string());
        skills.insert(CommandMode::Health, include_str!("./skills/health/SKILL.md").to_string());
        skills.insert(CommandMode::Kami,   include_str!("./skills/kami/SKILL.md").to_string());
