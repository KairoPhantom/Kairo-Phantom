...
1. Write a script `kairo-sidecar/scratch_run_w1.py` or similar to programmatically instantiate all 12 domain prompt builders and assert that the generated prompts:
...
Write your findings to `.agents/challenger_1/handoff.md`.
