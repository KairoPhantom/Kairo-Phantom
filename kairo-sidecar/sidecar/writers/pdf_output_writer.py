...
def _write_to_pdf(content: dict, dest_path: Path):
    ...
    log.error(f"Neither WeasyPrint nor ReportLab was available. Saved beautiful HTML report to {html_dest} instead.")
    raise RuntimeError("PDF generation failed: Neither WeasyPrint nor ReportLab was available. Saved HTML version.")
