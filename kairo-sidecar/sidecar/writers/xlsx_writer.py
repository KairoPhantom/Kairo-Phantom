        ...
        for op in operations:
            try:
                ...
                if op_type == "write_cell":
                    ...
                    applied.append({"type": "write_cell", "cell": cell_ref, "written": str(write_val)[:100]})
                    ...
                    ws[cell_ref].number_format = number_format
                    applied.append({"type": "set_number_format", "cell": cell_ref, "format": number_format})
                    ...
                    ws[cell_ref] = formula
                    applied.append({"type": "write_formula", "cell": cell_ref, "formula": str(formula)[:100]})
                    ...
                    if cell_ref:
                        ...
                        write_val = formula if formula else value
                        ws[cell_ref] = write_val
                        applied.append({"type": "legacy_write", "cell": cell_ref, "written": str(write_val)[:100]})
                    else:
