...
class ForgeValidator:
    """Wraps Forge formula validation. Prevents bad formulas reaching the file."""
    ...
    KNOWN_FUNCTIONS = {
        "SUM", "AVERAGE", "COUNT", "COUNTA", "MIN", "MAX", "IF", "IFS",
        "VLOOKUP", "HLOOKUP", "INDEX", "MATCH", "OFFSET", "INDIRECT",
        "SUMIF", "SUMIFS", "COUNTIF", "COUNTIFS", "AVERAGEIF", "AVERAGEIFS",
        "IFERROR", "IFNA", "AND", "OR", "NOT", "TRUE", "FALSE",
        ...
        "SUMPRODUCT", "XLOOKUP", "FILTER", "SORT", "UNIQUE", "LET", "LAMBDA",
        "PMT", "NPV", "IRR", "PV", "FV", "ISNUMBER", "ISBLANK", "ISERR", "ISERROR",
        "ISNA", "ISTEXT", "ISNONTEXT", "LOG", "LOG10", "LN", "EXP", "SQRT", "PI",
        "POWER", "PRODUCT", "STDEV", "STDEVP", "VAR", "VARP", "MEDIAN", "MODE",
        "CONCAT", "CONCATENATE", "TEXTJOIN", "REPLACE", "SUBSTITUTE", "FIND",
        "SEARCH", "CLEAN", "CHAR", "CODE", "PROPER"
    }
    ...
    def validate_and_fix(self, formula: str, locale: str = "en") -> dict:
        ...
        if ",," in clean_for_args or "(," in clean_for_args or ",)" in clean_for_args:
        ...
        for fn in ["VLOOKUP", "XLOOKUP", "SUMIF", "COUNTIF", "AVERAGEIF", "IFERROR", "MID", "INDEX", "ROUND", "IF", "LEFT"]:
            pattern = rf"\b{fn}\(([^)]+)\)"
            for match in re.finditer(pattern, clean_for_args, re.IGNORECASE):
        ...
        return {"valid": True, "formula": formula}
